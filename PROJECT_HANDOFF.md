...
2. **P1: converge the two fallback decision ladders** (`BrowserMindSystem` / `RuleBasedAiDecisionService`): shared thresholds and skill formula. Airlock rules (#88) and reachability (#91) are done; next slice is the skill formula.
