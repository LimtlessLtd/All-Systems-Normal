...
public static class CrewAffordanceSystem
{
    ...
    [
        ...
        new(ActionKind.SeekSafety, "room", "Move to a safer compartment when threatened."),
        new(ActionKind.FightFire, "room", "Suppress an active fire with local emergency equipment."),
        new(ActionKind.PatchHull, "breached-room", "Wear EVA repair gear and patch a reachable hull breach."),
        new(ActionKind.EvacuateHazard, "room", "Evacuate to a chosen safer compartment."),
        new(ActionKind.SealHazardRoom, "room", "Close hatches around a hazardous compartment."),
        new(ActionKind.VentHazardRoom, "room", "Vent fire/smoke, trading pressure and oxygen for suppression."),
        ...
        new(ActionKind.Eat, "optional-dining-room", "Eat in the galley or carry a meal to a listed dining room."),
        new(ActionKind.Rest, "none", "Rest in crew quarters."),
        new(ActionKind.Sleep, "none", "Sleep in crew quarters."),
        new(ActionKind.Recreate, "optional-activity", "Use recreation facilities or take a plain break."),
        ...
        new(ActionKind.AskAboutLocation, "crew", "Ask someone about a person you are concerned is missing."),
        ...
        new(ActionKind.MisleadCrew, "crew", "Misdirect someone; deterministic evidence still governs beliefs."),
        ...
        new(ActionKind.ProposePact, "crew", "Offer a concrete personal promise or deal."),
        new(ActionKind.Suggest, "crew", "Suggest a concrete action; the other person decides independently."),
        new(ActionKind.AcceptPact, "pact-proposal", "Accept a pending pact proposal."),
        new(ActionKind.FulfillPact, "pact", "Keep one of your active promises."),
        new(ActionKind.BreakPact, "pact", "Break one of your active promises."),
        ...
        new(ActionKind.HideItem, "possession", "Hide a possession you currently hold in this room."),
        new(ActionKind.ReturnItem, "possession", "Retrieve a possession you know is hidden in this room."),
        new(ActionKind.BorrowItem, "possession", "Ask a co-located holder to lend a known possession; they may refuse."),
        new(ActionKind.StealItem, "possession", "Take a known possession from its co-located holder or known local hiding place."),
        new(ActionKind.DestroyItem, "possession", "Destroy a known possession you hold, can reach locally, or know is hidden here."),
        ...
        new(ActionKind.AssumeRole, "vacant-post", "Take a vacant post whose former holder you know has died.")
    ];
