...
- Status: ready. Bullet 1 of the same message (decision output cap 300 → 750) was pushed by the owner directly; the `num_ctx` stop-gap and its budget test shipped alongside.
